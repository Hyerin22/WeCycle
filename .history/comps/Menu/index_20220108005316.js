...
if(opensub3){
    ...
    <MenuCont borderbottom={borderbottom}>
        ...
        <Contholder width={width} height={height}>
            ...
            <RegionHolder2 className="regionbutton2" onClick={()=>setOpensub2(!opensub2)}>
                ...
                <Infoholder2 subheight2={subheight2} subwidth2={subwidth2} display2={display2} >
                    <People className="sub2"  onClick={()=>router.push(routeToUrbanPeople)} >People</People>
                    <Environment className="sub2"  onClick={()=>router.push(routeToUrbanEnvironment)}>Environment</Environment>
                    <Animals className="sub2"  onClick={()=>router.push(routeToUrbanAnimals)}>Animals</Animals>
                    <Quitime className="sub2" onClick={()=>router.push(routeToUrbanQuiz)}>Quiz Time</Quitime>
                    <Volunteer className="sub2"  onClick={()=>router.push(routeToUrbanVolunteer)}>Volunteer</Volunteer>
                </Infoholder2>
            <RegionHolder3 className="regionbutton3" onClick={()=>setOpensub3(!opensub3)}>
            ...
            <Infoholder3 subheight3={subheight3} subwidth3={subwidth3} display3={display3}>
                <People className="sub3" onClick={()=>router.push(routeToLandfillPeople)} >People</People>
                <Environment className="sub3" onClick={()=>router.push(routeToLandfillEnvironment)}>Environment</Environment>
                <Animals className="sub3" onClick={()=>router.push(routeToLandfillAnimals)}>Animals</Animals>
                <Quitime className="sub3" onClick={()=>router.push(routeToLandfillQuiz)}>Quiz Time</Quitime>
                <Volunteer className="sub3" onClick={()=>router.push(routeToLandfillVolunteer)}>Volunteer</Volunteer>
            </Infoholder3>
